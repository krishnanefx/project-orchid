...
import { CalendarBlank, ChatCircleText, CurrencyGbp, MapPin, QrCode, Storefront, UsersThree, X } from "@phosphor-icons/react";
...
function TicketModal({ event, userId, onClose }: { event: OrchidEvent; userId: string; onClose: () => void }) {
