...
import { CheckCircle, DownloadSimple, FileArrowUp, Note, Receipt, Warning } from "@phosphor-icons/react";
import { useState } from "react";
import { z } from "zod";
import { useApp } from "@/lib/app-context";
import { reviewClaimAction, submitClaimAction, uploadReceiptAction } from "@/lib/actions";
  ...
  async function submitClaim() {
    ...
    try {
      ...
      const saved = await submitClaimAction(
        { claimant: currentUser.name, societyId: currentUser.societyId, amount: result.data.amount, purpose: result.data.purpose, receiptName, budgetCategory },
        currentUser.id,
      );
